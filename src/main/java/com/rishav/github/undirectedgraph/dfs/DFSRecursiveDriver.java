...
import com.rishav.github.undirectedgraph.dfs.service.impl.DFSRecursiveImpl;
import com.rishav.github.undirectedgraph.ds.Edge;
import com.rishav.github.undirectedgraph.ds.Graph;

public class DFSRecursiveDriver {
	...
	public static void main(String[] args) {
		...
		DFSService dfsRec = new DFSRecursiveImpl(graph, N, 0);
		for(int v=0; v<N; v++) {
			if(!marked[v]) {
				dfsRec.DFS(graph, v);
			}
